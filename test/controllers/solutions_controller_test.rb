...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { answer: @solution.answer, problem_id: @solution.problem_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { answer: @solution.answer, problem_id: @solution.problem_id } }
