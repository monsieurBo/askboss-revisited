...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { answer: @answer.answer, user_id: @answer.user_id } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { answer: @answer.answer, user_id: @answer.user_id } }
