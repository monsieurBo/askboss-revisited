...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { question: @problem.question, quiz_id: @problem.quiz_id } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { question: @problem.question, quiz_id: @problem.quiz_id } }
